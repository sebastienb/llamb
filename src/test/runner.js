...
// This runner executes the tests defined in comprehensive-tests.js
...
import { ALL_TEST_CATEGORIES } from './comprehensive-tests.js';
...
const CONFIG = {
  ...
  // Output report file
  reportFile: join(__dirname, 'test-report.md'),
  // Binary path - use the local executable
  binaryPath: join(dirname(dirname(__dirname)), 'llamb')
};
