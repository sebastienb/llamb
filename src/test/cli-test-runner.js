// CLI Test Runner for LLaMB
// This script executes tests for all llamb CLI commands and generates a report
...
const CONFIG = {
  ...
  // Output report file
  reportFile: path.join(__dirname, 'test-report.md'),
  // Binary path
...
const TEST_CATEGORIES = [
  ...
  },
  {
    ...
    tests: [
      {
        name: 'Verify ESC handling setup',
...
async function runTests() {
  console.log(chalk.bold.blue('🧪 Starting LLaMB CLI Tests 🧪'));
...
async function generateReport(results) {
  ...
  let report = `# LLaMB CLI Test Report\n\n`;
